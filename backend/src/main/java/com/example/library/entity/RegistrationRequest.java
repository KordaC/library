...
public class RegistrationRequest {
    ...
    @Column(name = "created_card_id")
    private UUID createdCardId;
    ...
    public UUID getCreatedCardId() { return createdCardId; }
    public void setCreatedCardId(UUID createdCardId) { this.createdCardId = createdCardId; }
